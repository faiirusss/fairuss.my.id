...
export default function Navbar() {
  ...
  return (
    <div
      className={`pointer-events-none fixed items-center inset-x-5 bottom-0 ${
        hasScrolled ? "md:top-2" : "md:top-6"
      } z-30 mb-4 flex origin-bottom h-full max-h-14`}
    >
      <p className="text-sm hidden md:block">Bandung/Indonesia</p>
